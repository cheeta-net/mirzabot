...
$puzzlenetpaykeyboard = json_encode([
    'keyboard' => [
        [['text' => $textbotlang['keyboard']['puzzleNetPayApiKey']], ['text' => $textbotlang['keyboard']['puzzleNetPayApiUrl']]],
        [['text' => $textbotlang['keyboard']['cashbackPuzzleNetPay']]],
        [['text' => $textbotlang['keyboard']['minAmountPuzzleNetPay']], ['text' => $textbotlang['keyboard']['maxAmountPuzzleNetPay']]],
        [['text' => $textbotlang['keyboard']['setEducationPuzzleNetPay']]],
        [['text' => $textbotlang['Admin']['backAdminBtn']], ['text' => $textbotlang['Admin']['backMenuBtn']]]
    ],
    'resize_keyboard' => true
]);
...
$PaySettingpuzzlenetpay = getPaySettingValue("statuspuzzlenetpay");
...
if ($PaySettingpuzzlenetpay == "onpuzzlenetpay") {
    $step_payment['inline_keyboard'][] = [
        ['text' => $textbotlang['textbot']['puzzleNetPay'], 'callback_data' => "puzzlenetpay"]
    ];
}
