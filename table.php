...
try {
    ...
    $settings = [
        ...
        ['Exception_auto_cart', '{}'],
        ['marchent_floypay', '0'],
        ['statuspuzzlenetpay', 'offpuzzlenetpay'],
        ['puzzlenetpay_api_key', '0'],
        ['puzzlenetpay_api_url', '0'],
        ['minbalancepuzzlenetpay', $main],
        ['maxbalancepuzzlenetpay', $max],
        ['chashbackpuzzlenetpay', '0'],
        ['helppuzzlenetpay', '2'],
    ];
    if (!$table_exists) {
